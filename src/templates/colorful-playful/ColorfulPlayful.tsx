...
import s from './colorful-playful.module.css';
...
export default function ColorfulPlayful({ products, settings }: TemplateProps) {
      ...
      <section className={s.hero}>
        ...
        <div className={s.searchWrapper}>
          ...
          <input
            ...
            placeholder={settings.search_placeholder || 'What are you looking for?'}
            value={search}
